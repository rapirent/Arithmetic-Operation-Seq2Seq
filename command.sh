...
# python3 ./multiply.py "--epoch=2" "--output_name=train120000" "--data_size=150000" "--train_size=120000" "--digits=3"
python3 ./multiply.py "--epoch=2" "--output_name=train1200000" "--data_size=530000" "--train_size=500000" "--digits=3"
# python3 ./addition-subtractor.py "--epoch=2" "--output_name=digit4-train36000" "--data_size=66000" "--train_size=36000" "--digits=4"
# python3 ./addition-subtractor.py "--epoch=2" "--output_name=digit4-train45000" "--data_size=75000" "--train_size=45000" "--digits=4"
# python3 ./addition-subtractor.py "--epoch=2" "--output_name=digit4-train45000" "--data_size=90000" "--train_size=60000" "--digits=4"
